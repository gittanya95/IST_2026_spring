# import nose  # Commented for Python 3.12 compatibility
# from nose.tools import assert_almost_equal, ok_, eq_
# from nose.plugins.attrib import attr

# Compatibility replacements for nose
def assert_almost_equal(a, b, places=7, msg=None):
    assert abs(a - b) < 10**(-places), msg or f"{a} != {b} within {places} places"

def ok_(expr, msg=None):
    assert expr, msg or "Assertion failed"
